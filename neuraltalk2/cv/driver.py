...
while True:
  ...
  #opt['start_from'] = '/scr/r6/karpathy/NeuralTalk2-Android_checkpoints/good6/model_id0-565-1447975213.t7'

  optscmd = ''.join([' -' + k + ' ' + encodev(v) for k,v in opt.iteritems()])
  exe = cmd + optscmd + ' | tee /scr/r6/karpathy/NeuralTalk2-Android_checkpoints/out' + opt['id'] + '.txt'
  print exe
  os.system(exe)
