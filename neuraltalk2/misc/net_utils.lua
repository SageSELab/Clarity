...
function net_utils.language_eval(iter, predictions, id, preprotype)
  ...
  os.execute('./misc/call_python_caption_eval.sh val-' .. id .. '.json ' .. iter .. " " ..  id .. " " .. preprotype) -- i'm dying over here
  local result_struct = utils.read_json('coco-caption/scores-' .. id .. '.json') -- god forgive me
