...
unnesc_json = open("unnesc_likert_raw_data.json", "r")

# get json data as a dictionary
raw_data = json.load(unnesc_json)
unnesc_json.close()
...
plt.xticks([1,2,3], ["None","Some", "A Lot"])

ax = plt.subplot(111)
ax.set_axisbelow(True)
ax.set_title("Distributions of 'Unnecessary' Likerts")
ax.set_xlabel("Amount of Unecessary Information")
...
plt_name = "unnecessary_likert_boxplot.pdf"
