...
class COCO:
    def __init__(self, annotation_file=None, annotation_dict=None):
        """
        ...
        if not annotation_file == None:
            ...
            self.createIndex()
        elif annotation_dict != None: # the user provided a dictionary instead of a filename
            #print("copying annotations from input dictionary...")
    ...
    def showAnns(self, anns):
        ...
        if self.dataset['type'] == 'captions':
            pass#for ann in anns:
                #print(ann['caption'])

    def loadRes(self, resFile=None, res_dict=None):
        """
        ...
        # one of these two variables need to exist
        assert((resFile != None) or (res_dict != None))
        
        # we prioritorize resFile
        if resFile != None:
            anns    = json.load(open(resFile))
        else: # grab the res_dict from memory
            anns = res_dict
